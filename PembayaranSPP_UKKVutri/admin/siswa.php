...
<table class="table table-striped table-bordered">
    ...
    foreach ($query as $data) { ?>
        <tr>
            ...
            <td>
                <a href="?url=edit-siswa&nisn=<?= $data['nisn'] ?>" class="btn btn-primary">EDIT</a>
            </td>
            <td>
                <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')" href="?url=hapus-siswa&nisn=<?= $data['nisn'] ?>" class="btn btn-primary">HAPUS</a>
            </td>
        </tr>
    <?php } ?>
</table>